...
<table class="table table-responsive" border="2" style="border-color:black;size:16px;color:white;font-weight:bold;font-size:19px;">
<tr>
<th>slno</th>
<th>dvd name</th>
<th>artists</th>
...
<h2 ><b>ENTERTAINMENT SECTION</b></h2>
 <?php error_reporting($level = null);
include('config.php');
$file=file_get_contents("sanu.txt");
$sqll="select * from dvd where catid=1";
$res=$conn->query($sqll);
$i=1;
