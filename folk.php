...
<table class="table" border="4" style="border-color:white;white;font-weight:bold;font-size:19px;">
<tr>
<th>slno</th>
<th>dvd name</th>
<th>artists</th>
...
<center>
<h1><b>FOLK SECTION</b></h1></center>
 <?php error_reporting($level = null);
include('config.php');
$file=file_get_contents("san.txt");
$sqll="select * from dvd where catid=2";
$res=$conn->query($sqll);
$i=1;
