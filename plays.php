...
<table class="table" border="2" style="border-color:black;white;font-weight:bold;font-size:19px;">
<tr>
<th>slno</th>
<th>dvd name</th>
<th>artists</th>
...
<h1>PLAYS SECTION</h1></center>
 <?php error_reporting($level = null);
include('config.php');
$file=file_get_contents("san.txt");
$sqll="select * from dvd where catid=4";
$res=$conn->query($sqll);
$i=1;
